...
if __name__ == '__main__' : 
    # python yolo_detection_webcam.py --model yolov3-tiny.weights
    ...
    """
    1. frame is working continuously 
        so, the information have to be printed per each 5 seconds (i.e)
    
        2. then get the information and make it speak
    """
